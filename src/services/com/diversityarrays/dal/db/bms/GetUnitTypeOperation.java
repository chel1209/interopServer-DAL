 ...
 * @date 12-NOV-2015
 */
public class GetUnitTypeOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{

	
	public static final Pattern PATTERN = Pattern.compile("^list/type/unittype/active");
	public static final String  ENTITY_NAME = "UnitType";
	

	public GetUnitTypeOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/unittype/active", GeneralType.class, provider);
	}
