 ...
 * @date 12-NOV-2015
 */
public class GetTraitGroupOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{
	
	public static final Pattern PATTERN = Pattern.compile("^list/type/traitgroup/active");
	public static final String  ENTITY_NAME = "TraitGroup";
	
	public GetTraitGroupOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/traitgroup/active", GeneralType.class, provider);
	}
