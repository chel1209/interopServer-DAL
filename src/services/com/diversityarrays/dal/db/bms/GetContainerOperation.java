 ...
 * @date 12-NOV-2015
 */
public class GetContainerOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{

	
	public static final Pattern PATTERN = Pattern.compile("^list/type/container/active");
	public static final String  ENTITY_NAME = "Container";
	
	public GetContainerOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/container/active", GeneralType.class, provider);
	}	
