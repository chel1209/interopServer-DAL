 ...
 * @date 12-NOV-2015
 */
public class GetItemParentOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{

	
	public static final Pattern PATTERN = Pattern.compile("^list/type/itemparent/active");
	public static final String  ENTITY_NAME = "ItemParent";
	

	public GetItemParentOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/itemparent/active", GeneralType.class, provider);
	}	
