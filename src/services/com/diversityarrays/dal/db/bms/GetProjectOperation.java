...
public class GetProjectOperation extends EntityOperation<Project,BMS_DalDatabase>{
	...
	public static final Pattern PATTERN = Pattern.compile("^projects/");
	...
	public GetProjectOperation(BMS_DalDatabase db, EntityProvider<Project> provider){
		//super(db, ENTITY_NAME, "list/project/_numberpage/page/_num", Project.class, provider);
		super(db, ENTITY_NAME, "projects/", Project.class, provider);
	}
