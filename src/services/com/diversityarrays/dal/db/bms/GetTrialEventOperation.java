 ...
 * @date 12-NOV-2015
 */
public class GetTrialEventOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{
	
	public static final Pattern PATTERN = Pattern.compile("^list/type/trialevent/active");
	public static final String  ENTITY_NAME = "TrialEvent";
	
	public GetTrialEventOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/trialevent/active", GeneralType.class, provider);
	}
