 ...
 * @date 12-NOV-2015
 */
public class GetGenoTypeAliasStatusOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{

	
	public static final Pattern PATTERN = Pattern.compile("^list/type/genotypealiasstatus/active");
	public static final String  ENTITY_NAME = "GenoTypeAliasStatus";
	
	public GetGenoTypeAliasStatusOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/genotypealiasstatus/active", GeneralType.class, provider);
	}
