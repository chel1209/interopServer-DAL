 ...
 * @date 12-NOV-2015
 */
public class GetSpecimenGroupOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{

		
	public static final Pattern PATTERN = Pattern.compile("^list/type/specimengroup/active");
	public static final String  ENTITY_NAME = "SpecimenGroup";
	
	public GetSpecimenGroupOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/specimengroup/active", GeneralType.class, provider);
	}
