 ...
 * @date 12-NOV-2015
 */
public class GetGenParentOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{

	public static final Pattern PATTERN = Pattern.compile("^list/type/genparent/active");
	public static final String  ENTITY_NAME = "GenParent";
	
	public GetGenParentOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/genparent/active", GeneralType.class, provider);
	}
