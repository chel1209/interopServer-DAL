 ...
 * @date 12-NOV-2015
 */
public class GetGenoTypeAliasOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{

	
	public static final Pattern PATTERN = Pattern.compile("^list/type/genotypealias/active");
	public static final String  ENTITY_NAME = "GenotypeAlias";
	
	public GetGenoTypeAliasOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/genotypealias/active", GeneralType.class, provider);
	}
