 ...
 * @date 12-NOV-2015
 */
public class GetSampleOperation extends EntityOperation<GeneralType,BMS_DalDatabase> {
	
	
	public static final Pattern PATTERN = Pattern.compile("^list/type/sample/active");
	public static final String  ENTITY_NAME = "Sample";	

	public GetSampleOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
