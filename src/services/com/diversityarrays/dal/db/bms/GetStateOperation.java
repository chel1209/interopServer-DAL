 ...
 * @date 12-NOV-2015
 */
public class GetStateOperation extends EntityOperation<GeneralType,BMS_DalDatabase>{

	
	public static final Pattern PATTERN = Pattern.compile("^list/type/state/active");
	public static final String  ENTITY_NAME = "State";
	
	public GetStateOperation(BMS_DalDatabase db, EntityProvider<GeneralType> provider){
		super(db, ENTITY_NAME, "list/type/state/active", GeneralType.class, provider);
	}	
